    ...
    initEvents() {
        ...
        for (const [position, gridItem] of this.gridItemArr.entries()) {
            ...
            gridItem.DOM.img.outer.addEventListener('click', (event) => {
                ...
                console.log(this.DOM.heading.bottom)
        ...
        this.DOM.backCtrl.addEventListener('click', () => {
            ...
            if(winsize.width>=846){
                const myElements = document.querySelectorAll('.column__item');
                myElements.forEach(element => {
                element.style.border = '20px rgb(82, 59, 40) dashed';
                });
            }else{
                if(winsize.width>=750){
                    const myElements = document.querySelectorAll('.column__item');
                    myElements.forEach(element => {
                    element.style.border = '17px rgb(82, 59, 40) dashed';
                    });
                }else{
                    if(winsize.width>=450){
                        const myElements = document.querySelectorAll('.column__item');
                        myElements.forEach(element => {
                        element.style.border = '12px rgb(82, 59, 40) dashed';
                        });
                    }else{
                        const myElements = document.querySelectorAll('.column__item');
                        myElements.forEach(element => {
